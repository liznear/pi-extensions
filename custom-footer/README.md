...
- Usage summary (`↑12.3K / ↓4.5K / $91%`, K/M formatted): ↑ cumulative input tokens, ↓ output tokens, $ cache hit rate (`cacheRead / (input + cacheRead + cacheWrite)`) aggregated over assistant messages in the current branch
- Last run duration
