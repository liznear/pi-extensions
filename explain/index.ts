...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		promptSnippet: "Create rich, self-contained HTML explanation pages with beautiful styling, SVG diagrams, and interactive elements.",
		promptGuidelines: [
		...
		parameters: Type.Object({
			htmlContent: Type.String({ description: "Full self-contained HTML content of the page (must include <!DOCTYPE html> with embedded CSS and JS, no external dependencies)" }),
			title: Type.Optional(Type.String({ description: "Title for the page, used as filename hint" })),
		}),
		async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
			...
			return {
				content: [{ type: "text", text: `HTML page saved to ${filePath} and opened in your browser.` }],
